      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-3">
            <img src="/img/logo.png" alt="The Scratch Lab Logo" className="h-12 w-12 object-contain" />
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <button onClick={() => scrollToSection('why-us')} className="text-gray-300 hover:text-white transition-colors">
              Why Us
            </button>
            ...
            <div className="flex items-center gap-4 ml-4 pl-4 border-l border-gray-700">
              <a href="tel:+12673793167" className="text-blue-400 hover:text-blue-300 transition-colors" aria-label="Call us">
                <Phone className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/leather_repair_service2222" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61572483165003" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="Facebook">
        ...
        {isMenuOpen && (
          <div className="lg:hidden pb-4 border-t border-gray-800 mt-2">
            <nav className="flex flex-col gap-4 pt-4">
              ...
              <button onClick={() => scrollToSection('gallery')} className="text-gray-300 hover:text-white transition-colors text-left">
                Gallery
              </button>
              <button onClick={() => scrollToSection('process')} className="text-gray-300 hover:text-white transition-colors text-left">
                Process
              </button>
              <button onClick={() => scrollToSection('why-us')} className="text-gray-300 hover:text-white transition-colors text-left">
                Why Us
              </button>
