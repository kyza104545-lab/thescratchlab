...
export default function Appointment() {
  ...
  const validatePhone = (phone: string) => /^[+()\-\s\d]{7,20}$/.test(phone);
  ...
  const validateForm = () => {
    ...
    else if (!validateZip(formData.zip)) e.zip = 'Invalid ZIP (e.g., 12345 or 12345-6789)';
    setErrors(e);
  ...
  const handleFileChange = (ev: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (valid.length + files.length > 5) { setErrorMessage('Maximum 5 photos allowed'); return; }
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      for (const f of files) photoUrls.push(await dataUrlFromFile(f));
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8">
              ...
              <a href="tel:+12673793167" className="text-blue-400 hover:text-blue-300">267-379-3167</a>
            </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-900 border ${errors.name ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-900 border ${errors.email ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-900 border ${errors.phone ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500`}
              ...
              <div>
                ...
                <input
                  id="car" type="text" value={formData.car}
                  onChange={(e) => setFormData({ ...formData, car: e.target.value })}
                  className={`w-full px-4 py-3 bg-gray-900 border ${errors.car ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500`}
              ...
              <div>
                ...
                <input
                  id="zip" type="text" value={formData.zip}
                  onChange={(e) => setFormData({ ...formData, zip: e.target.value })}
                  className={`w-full px-4 py-3 bg-gray-900 border ${errors.zip ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500`}
                  placeholder="18901" pattern="^\d{5}(-\d{4})?$"
                />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    id="photos" type="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp"
                    multiple onChange={handleFileChange} disabled={files.length >= 5} className="hidden"
                  />
                  <label
                    htmlFor="photos"
                  ...
                  <div className="mt-4 space-y-2">
                    {files.map((file, i) => (
                      <div key={i} className="flex items-center justify-between p-3 bg-gray-900 rounded-lg">
                        ...
                        <button type="button" onClick={() => removeFile(i)} className="ml-2 text-red-400 hover:text-red-300">Remove</button>
                      </div>
                    ))}
                  </div>
                )}
